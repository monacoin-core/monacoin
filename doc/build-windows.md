...
Below are some notes on how to build Monacoin Core for Windows.

The options known to work for building Monacoin Core on Windows are:
...
Note that for WSL the Monacoin Core source path MUST be somewhere in the default mount file system, for
