...
This guide describes how to build monacoind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/monacoin/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/monacoin/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Monacoin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/monacoin/monacoin/issues/6658)).
