...
#ifndef MONACOIN_WALLET_TRANSACTION_H
#define MONACOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this monacoin node, and set to 0 for transactions that were created
...
#endif // MONACOIN_WALLET_TRANSACTION_H
