...
#ifndef MONACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define MONACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Monacoin Core wallet was originally a collection of unrelated private
...
#endif // MONACOIN_WALLET_SCRIPTPUBKEYMAN_H
