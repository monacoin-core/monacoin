...
BOOST_AUTO_TEST_CASE(knapsack_solver_test)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK_EQUAL(result14->GetSelectedValue(), 1 * COIN);  // we should get 1 MONA in 1 coin
        ...
        BOOST_CHECK_EQUAL(result15->GetSelectedValue(), 2 * COIN);  // we should get 2 MONA in 1 coin
...
BOOST_AUTO_TEST_CASE(check_max_weight)
{
    ...
    {
        // Scenario 1:
        // The actor starts with 1x 50.0 MONA and 1515x 0.033 MONA (~100.0 MONA total) unspent outputs
        // Then tries to spend 49.5 MONA
        // The 50.0 MONA output should be selected, because the transaction would otherwise be too large
...

    {
        ...
        // The actor starts with 400x 0.0625 MONA and 2000x 0.025 MONA (75.0 MONA total) unspent outputs
        // Then tries to spend 49.5 MONA
...

    {
        ...
        // The actor starts with 1515x 0.033 MONA (49.995 MONA total) unspent outputs
...
BOOST_AUTO_TEST_CASE(SelectCoins_effective_value_test)
{
    ...
    CoinsResult available_coins;
    {
        ...
        add_coin(available_coins, *dummyWallet, 100000); // 0.001 MONA
    }

    CAmount target{99900}; // 0.000999 MONA
