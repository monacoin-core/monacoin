...
#ifndef MONACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MONACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MONACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
