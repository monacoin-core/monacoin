 ...
 */
#ifndef MONACOIN_UTIL_SYSTEM_H
#define MONACOIN_UTIL_SYSTEM_H
...
extern const char * const MONACOIN_CONF_FILENAME;
extern const char * const MONACOIN_SETTINGS_FILENAME;
