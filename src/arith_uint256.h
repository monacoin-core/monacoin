...
#ifndef MONACOIN_ARITH_UINT256_H
#define MONACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Monacoin only uses this "compact" format for encoding difficulty
...
#endif // MONACOIN_ARITH_UINT256_H
