...
{
    BOOST_CHECK(TestSplitHost("www.monacoincore.org", "www.monacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.monacoincore.org]", "www.monacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.monacoincore.org:80", "www.monacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.monacoincore.org]:80", "www.monacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.monacoincore.org:65536", "www.monacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.monacoincore.org:0", "www.monacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.monacoincore.org:", "www.monacoincore.org:", 0, false));
}
