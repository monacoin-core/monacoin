...
#ifndef MONACOIN_INTERFACES_NODE_H
#define MONACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a monacoin node (monacoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or monacoin.conf.
...
#endif // MONACOIN_INTERFACES_NODE_H
