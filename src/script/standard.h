...
#ifndef MONACOIN_SCRIPT_STANDARD_H
#define MONACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a monacoin address
 */
...
/**
 * Generate a Monacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MONACOIN_SCRIPT_STANDARD_H
