...
#ifndef MONACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define MONACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // MONACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
