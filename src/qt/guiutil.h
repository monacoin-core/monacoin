...
#ifndef MONACOIN_QT_GUIUTIL_H
#define MONACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Monacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "monacoin:" URI into recipient object, return true on successful parsing
