...
//! Entry point for MonacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MonacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MonacoinGUI tests.
void AppTests::guiTests(MonacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MonacoinGUI::consoleShown, this, &AppTests::consoleTests);
