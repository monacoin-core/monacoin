      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->monacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->monacoinAtStartup);
    ...
    ui->monacoinAtStartup->setToolTip(ui->monacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->monacoinAtStartup->setText(ui->monacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMonacoinConfButton->setToolTip(ui->openMonacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MonacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->monacoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSMONAontrols);
...
void OptionsDialog::on_openMonacoinConfButton_clicked()
{
