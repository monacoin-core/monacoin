...
interfaces.
- [util](/test/util) which tests the utilities (monacoin-util, monacoin-tx, ...).
...
Before tests can be run locally, Monacoin Core must be built.  See the [building instructions](/doc#building) for help.
