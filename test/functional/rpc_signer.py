...
Verify that a monacoind node can use an external signer command.
...
class RPCSignerTest(MonacoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart monacoind with -signer=<cmd>',
