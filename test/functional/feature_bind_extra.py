...
"""
Test starting monacoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MonacoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that monacoind has bound on "::1" (for RPC) and "::" (for P2P).
