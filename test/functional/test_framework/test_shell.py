...
class TestShell:
    """Wrapper Class for MonacoinTestFramework.

    The TestShell class extends the MonacoinTestFramework
    ...
    class __TestShell(MonacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MonacoinTestFramework child class.
            self.num_nodes = 1
