...
# The block reward of coinbaseoutput.nValue (50) MONA/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 MONA/block.
...
class TestMonacoinCli(MonacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and monacoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and monacoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (MONA/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (MONA/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 MONA) to the default wallet.
            ...
            # Test monacoin-cli -generate with -rpcwallet in multiwallet mode.
