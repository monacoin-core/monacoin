...
By default, monacoind will dump mempool on shutdown and
...
class MempoolPersistTest(MonacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent monacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
