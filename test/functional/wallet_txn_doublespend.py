...
class TxnMallTest(MonacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MONA:
        ...
        # First: use raw transaction API to send 1240 MONA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MONA coin each
        ...
        # Node0's balance should be starting balance, plus 50MONA for another
        ...
        # Node0's total balance should be starting balance, plus 100MONA for
