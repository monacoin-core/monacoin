...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MonacoinTestFramework
    pass


class ExampleTest(MonacoinTestFramework):
    # Each functional test is a subclass of the MonacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MonacoinTestFramework class so other tests can use it."""
