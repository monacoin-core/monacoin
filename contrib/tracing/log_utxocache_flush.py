...
"""Example logging Monacoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/monacoind
...
def main(monacoind_path):
    ...
    # to the tracepoints
    monacoind_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[monacoind_with_usdts])
