...
# Extract options
function __fish_monacoin_tx_get_options
...
# Extract commands
function __fish_monacoin_tx_get_commands
...
complete \
    --command monacoin-tx \
    --condition "not __fish_monacoin_seen_cmd (__fish_monacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_monacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command monacoin-tx \
    --arguments "(__fish_monacoin_tx_get_commands)" \
    --no-files
