...
complete --command monacoind --no-files

# Extract options
function __fish_monacoind_get_options
...
complete \
    --command monacoind \
    --arguments "(__fish_monacoind_get_options --nofiles)"
