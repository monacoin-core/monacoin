...
complete --command monacoin-qt --no-files

# Extract options
function __fish_monacoinqt_get_options
...
complete \
    --command monacoin-qt \
    --arguments "(__fish_monacoinqt_get_options --nofiles)"
