...
def monacoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.monacoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = monacoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = monacoin_cli(['getnewaddress', 'faucet', 'bech32'])
